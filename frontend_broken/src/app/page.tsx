              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Décrire tout autre avantage non listé ci-dessus..." {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Inclure une clause de non-divulgation (NDA) ?</FormLabel>
                        </FormItem>
                      )}
                    />
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Inclure une clause de non-concurrence ?</FormLabel>
                        </FormItem>
                      )}
                    />
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Avocat à nommer dans la clause de notification ?</FormLabel>
                        </FormItem>
                      )}
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-b pb-2">
                    Autres éléments ou clauses spécifiques
                  </h3>
                  <FormField
                    control={form.control}
                    name="prose"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Décrivez ici, en langage courant, toute autre demande spécifique ou clause à inclure.
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder="Ex: &apos;Je veux une clause qui stipule que le matériel informatique fourni reste la propriété de l&apos;entreprise et doit être retourné en fin de contrat...&apos;"
                            rows={5}
                            {...field}
                          />
                        </FormControl>
